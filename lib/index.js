 ...
 */
var publishOnePage = function (pageUrl) {
    ...
    var htmlCode = analyzeHtml(pageUrl, path.resolve(cwd, './__publish__'), pageName);
    ...
    console.log('#yellow{minify ' + pageUrl + ' done}\n\n');
...
var analyzeHtml = function (htmlpath, projectRoot, pageName) {
    var content = puz.puz(path.resolve(cwd, htmlpath));
...
var collectAllPages = function (dir) {
    ...
    if (stat.isDirectory()) {
        ...
        files.forEach(function (value) {
            ...
            } else if (path.extname(realPath) === '.html' || path.extname(realPath) === '.htm') {
